...
def bucket_income_bq(val):
    ...
    under_50k = ['under $10,000', '$10,000 - $14,999', 'less than $20,000', '$20,000 - $24,999', '$25,000 - $29,999', '$30,000 - $34,999', '$35,000 - $39,999', '$40,000 - $44,999', '$45,000 - $49,999', '$45,000 to $59,999']
    from_50k_to_100k = ['$50,000 - $54,999', '$55,000 - $59,999', '$60,000 - $64,999', '$65,000 - $74,999', '$75,000 - $99,999']
    from_100k_to_150k = ['$100,000 - $149,999']
    from_150k_to_250k = ['$150,000 - $174,999', '$150,000 to $199,999', '$175,000 - $199,999', '$200,000 - $249,999']
    over_250k = ['$250,000 +']
...
def bucket_net_worth_bq(val):
    ...
    under_100k = ['less than $1', '$1 - $4,999', '$5,000 - $9,999', '$10,000 - $24,999', '$25,000 - $49,999', '$50,000 - $99,999', '-$2,499 to $2,499', '$2,500 to $24,999']
    from_100k_to_249k = ['$100,000 - $249,999', '$150,000 to $249,999']
    from_250k_to_499k = ['$250,000 - $499,999', '$375,000 to $499,999']
    over_500k = ['$499,999 or more', '$750,000 to $999,999']
