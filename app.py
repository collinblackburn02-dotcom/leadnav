            ...
            with summary_cols[i]:
                ...
                st.markdown(f'''
                    <div style="background-color: #F8F5FA; border: 1px solid {PITCH_BRAND_COLOR}; border-radius: 12px; padding: 15px; text-align: center; min-height: 120px; display: flex; flex-direction: column; justify-content: center; align-items: center;">
                        <p style="margin: 0; font-size: 1.2rem; color: #0F172A; font-weight: 700; text-transform: uppercase; font-family: Outfit, sans-serif;">{label}</p>
                        <h3 style="margin: 5px 0 10px 0; font-size: 1.0rem; color: #64748B; font-weight: 500; line-height: 1.2; font-family: Outfit, sans-serif !important;">{data[0]}</h3>
