...
if st.session_state.app_state == "onboarding":
    ...
    st.markdown("""
        <div style="text-align: center; margin-top: -15px; margin-bottom: 25px;">
            ...
            <h2 class="serif-subheadline" style="font-size: 2.1rem; color: #0F172A !important; margin-top: 5px;">Get instant demographic insights on your existing customers.</h2>
        </div>
    """, unsafe_allow_html=True)
    st.markdown("<p style='text-align: center; color: #64748B; font-family: Outfit, sans-serif; font-size: 1.1rem; margin-top: -15px;'>Upload Customer Data to begin.</p>", unsafe_allow_html=True)
